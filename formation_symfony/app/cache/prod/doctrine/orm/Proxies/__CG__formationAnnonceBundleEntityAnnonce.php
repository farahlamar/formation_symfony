...
namespace Proxies\__CG__\formation\AnnonceBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Annonce extends \formation\AnnonceBundle\Entity\Annonce implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'id', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'titre', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'contenu', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'date', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'auteur', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'Categorie', '' . "\0" . 'formation\\AnnonceBundle\\Entity\\Annonce' . "\0" . 'condidatures');
        }
    ...
    public function addCondidature(\formation\AnnonceBundle\Entity\Condidature $condidatures)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCondidature', array($condidatures));

        return parent::addCondidature($condidatures);
    }
    ...
    public function removeCondidature(\formation\AnnonceBundle\Entity\Condidature $condidatures)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCondidature', array($condidatures));

        return parent::removeCondidature($condidatures);
    }
    ...
    public function getCondidatures()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCondidatures', array());

        return parent::getCondidatures();
    }
